...
const lexer = moo.compile({
    ...
    keyword: ['typeof', 'instanceof', 'in', 'of', 'type', 'super', 'extends', 'function', 'this', 'echo', 'export', 'yield', 'async', 'try', 'catch', 'finally', 'static', 'while', 'if', 'else', 'import', 'from', 'let', 'const', 'null', 'of', 'default', 'switch', 'switch*', 'with', 'for', 'case', 'default', 'elif', 'debugger', 'or', 'and', 'return', 'new', 'is', 'is not', 'is greater than', 'is greater or equal to', 'is smaller than', 'is smaller or equal to', 'equal', 'throw', 'break', 'continue'].map(i => new RegExp(`\\b${i}\\b`)),
    regexp: /\/(?:\\[ ><bfnrtswSWdD.+*^$[\]{}|?:]|[^><\n\/\\])*?\//,
    operator: ['+', '-', '/', '**', '*', '%'],
