...
globalThis.BS = {
    ...
    //            return this.existsArray(type);
    //        }
    //        if (BS.customTypes[type]) return type;
    //        if (BS.types[type]) return type;
    ...
    //            if (!this.is(value[i], type)) return false;
    //        }
    //        return true;
    //    }
    //},
    validateType(value, type, nullable) {
        ...
        if (Array.isArray(type)) {
            for (let i in type) {
                ...
                else if (this.customTypes[type[i].replace('[]', '')]) t = this.customTypes[type[i].replace('[]', '')](value);
