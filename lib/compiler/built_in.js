...
globalThis.BS = {
    ...
    sum(value1, value2) {
        ...
        throw new TypeError('Number or String was expected for math expression, got "'+BS.getType(value1)+'" insetead');
        //return value1 + value2;
    },
    sub(value1, value2) {
        //if (Array.isArray(value1) && Array.isArray(value2)) {
    ...
    pow(value1, value2) {
        ...
        throw new TypeError('Number was expected for math expression, got "'+BS.getType(value1)+'" insetead');
        //return value1 + value2;
    },
    div(value1, value2) {
        if (value1 === null || value1 === void 0 || value2 === null || value2 === void 0) {
    ...
    mul(value1, value2) {
        ...
        if (typeof value1 === 'string') {
            if (typeof value2 !== 'number') {
                throw new TypeError('Number was expected for repeated concatination, got "'+BS.getType(value2)+'" insetead');
            }
            let result = '';
