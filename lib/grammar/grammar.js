...
function id(x) { return x[0]; }
    ...
    const getLastStack = function () {
        let last = pathStack[pathStack.length - 1]
...
var grammar = {
    ...
    {"name": "statement$ebnf$1$subexpression$1$subexpression$1", "symbols": [{"literal":"when"}]},
    {"name": "statement$ebnf$1$subexpression$1$subexpression$1", "symbols": [{"literal":"when"}, "__", {"literal":"not"}]},
    {"name": "statement$ebnf$1$subexpression$1", "symbols": ["__", "statement$ebnf$1$subexpression$1$subexpression$1", "statement_condition"]},
    ...
    {"name": "statement", "symbols": ["statement$subexpression$1", "statement$ebnf$1"], "postprocess": statement.break_continue},
    {"name": "statement", "symbols": [{"literal":"swap"}, "__", "superValue", "_", {"literal":","}, "_", "superValue"], "postprocess": statement.swap},
    {"name": "statement$ebnf$2$subexpression$1$ebnf$1$subexpression$1", "symbols": ["__", {"literal":"as"}, "__", "identifier"], "postprocess": v => v[3]},
    {"name": "statement$ebnf$2$subexpression$1$ebnf$1", "symbols": ["statement$ebnf$2$subexpression$1$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "statement$ebnf$2$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "statement$ebnf$2$subexpression$1$ebnf$2", "symbols": []},
    {"name": "statement$ebnf$2$subexpression$1$ebnf$2$subexpression$1$ebnf$1$subexpression$1", "symbols": ["__", {"literal":"as"}, "__", "identifier"], "postprocess": v => v[3]},
    {"name": "statement$ebnf$2$subexpression$1$ebnf$2$subexpression$1$ebnf$1", "symbols": ["statement$ebnf$2$subexpression$1$ebnf$2$subexpression$1$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "statement$ebnf$2$subexpression$1$ebnf$2$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "statement$ebnf$2$subexpression$1$ebnf$2$subexpression$1", "symbols": ["_", {"literal":","}, "_", "identifier", "statement$ebnf$2$subexpression$1$ebnf$2$subexpression$1$ebnf$1"], "postprocess": v => [v[3], v[4]]},
    {"name": "statement$ebnf$2$subexpression$1$ebnf$2", "symbols": ["statement$ebnf$2$subexpression$1$ebnf$2", "statement$ebnf$2$subexpression$1$ebnf$2$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "statement$ebnf$2$subexpression$1", "symbols": ["__", "identifier", "statement$ebnf$2$subexpression$1$ebnf$1", "statement$ebnf$2$subexpression$1$ebnf$2", "_", {"literal":"from"}]},
    ...
    {"name": "statement", "symbols": [{"literal":"import"}, "statement$ebnf$2", "__", "string_concat"], "postprocess": statement.import},
    {"name": "statement", "symbols": [{"literal":"import"}, "__", {"literal":"*"}, "__", {"literal":"as"}, "__", "identifier", "__", {"literal":"from"}, "__", "string_concat"], "postprocess": statement.importAll},
    {"name": "statement", "symbols": [{"literal":"export"}, "__", {"literal":"default"}, "__", "superValue"], "postprocess": statement.exportDefault},
    {"name": "statement$subexpression$2", "symbols": ["var_assign"]},
    {"name": "statement$subexpression$2", "symbols": ["class_declaration"]},
    {"name": "statement$subexpression$2", "symbols": ["superValue"]},
    {"name": "statement", "symbols": [{"literal":"export"}, "__", "statement$subexpression$2"], "postprocess": statement.export},
    ...
    {"name": "statements_block", "symbols": ["_", {"literal":":"}, "_", "statement"], "postprocess":  (v, l, r) => {
            //if (done.includes[l]) {
                //return r
            //}
            //done.push(l)
    ...
    {"name": "Var$subexpression$2", "symbols": ["array"]},
    {"name": "Var$subexpression$2", "symbols": ["arrow_arguments"]},
    {"name": "Var", "symbols": ["base", "_", {"literal":"-"}, {"literal":">"}, "_", "Var$subexpression$2"], "postprocess":  (v, l, reject) => {
            //if (v[0].type == 'annonymous_function') return reject
            let type = v[5][0].type == 'array' ? 'arrow_array_execution' : 'arrow_arguments_execution'
            return {
                type,
                from: v[0],
                value: v[5][0],
    ...
    {"name": "Var", "symbols": ["base", "_", {"literal":"."}, "_", "Var$subexpression$3"], "postprocess":  (v, l, reject) => {
            if (v[0].type == 'annonymous_function') return reject
    ...
    {"name": "Var$subexpression$4", "symbols": [(lexer.has("keyword") ? {type: "keyword"} : keyword)]},
    {"name": "Var$subexpression$4", "symbols": ["identifier"]},
    {"name": "Var", "symbols": [{"literal":"::"}, "Var$subexpression$4"], "postprocess":  (v, l, reject) => {
            return {
    ...
    {"name": "arrow_arguments$ebnf$1", "symbols": []},
    {"name": "arrow_arguments$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "arrow_argument"]},
    {"name": "arrow_arguments$ebnf$1", "symbols": ["arrow_arguments$ebnf$1", "arrow_arguments$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "arrow_arguments$ebnf$2$subexpression$1", "symbols": ["_", {"literal":","}]},
    {"name": "arrow_arguments$ebnf$2", "symbols": ["arrow_arguments$ebnf$2$subexpression$1"], "postprocess": id},
    {"name": "arrow_arguments$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "arrow_arguments", "symbols": [{"literal":"("}, "_", "arrow_argument", "arrow_arguments$ebnf$1", "arrow_arguments$ebnf$2", "_", {"literal":")"}], "postprocess": args.extract},
    {"name": "arrow_argument", "symbols": [{"literal":"&"}, "_", "arguments"], "postprocess":  v => ({
            type: 'arrow_argument',
            value: v[2],
        }) },
    {"name": "arrow_argument", "symbols": ["superValue"], "postprocess": id},
    ...
    {"name": "case_multiline$ebnf$2$subexpression$1", "symbols": [{"literal":";"}, "_"]},
    ...
    {"name": "case_multiline$ebnf$3$subexpression$1", "symbols": [{"literal":";"}, "_"]},
    {"name": "case_multiline$ebnf$3", "symbols": ["case_multiline$ebnf$3$subexpression$1"], "postprocess": id},
    {"name": "case_multiline$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "case_multiline", "symbols": [{"literal":"case"}, "__", "superValue", "_", {"literal":":"}, "_", {"literal":"{"}, "statements", "_", "case_multiline$ebnf$2", {"literal":"}"}, "case_multiline$ebnf$3"], "postprocess":  v => assign(v[0], {
            type: 'case',
            value: v[2],
            statements: v[7],
            scoped: true
        }) },
    {"name": "case_multiline$ebnf$4$subexpression$1", "symbols": [{"literal":";"}, "_"]},
    {"name": "case_multiline$ebnf$4", "symbols": ["case_multiline$ebnf$4$subexpression$1"], "postprocess": id},
    {"name": "case_multiline$ebnf$4", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "case_multiline$ebnf$5$subexpression$1", "symbols": [{"literal":";"}, "_"]},
    {"name": "case_multiline$ebnf$5", "symbols": ["case_multiline$ebnf$5$subexpression$1"], "postprocess": id},
    {"name": "case_multiline$ebnf$5", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "case_multiline", "symbols": [{"literal":"case"}, {"literal":"*"}, "__", "superValue", "_", {"literal":":"}, "_", {"literal":"{"}, "statements", "_", "case_multiline$ebnf$4", {"literal":"}"}, "case_multiline$ebnf$5"], "postprocess":  v => assign(v[0], {
            type: 'broken_case',
            value: v[3],
            statements: v[8],
            scoped: true
        }) },
    {"name": "case_multiline$ebnf$6$subexpression$1", "symbols": ["_", {"literal":";"}]},
    {"name": "case_multiline$ebnf$6", "symbols": ["case_multiline$ebnf$6$subexpression$1"], "postprocess": id},
    {"name": "case_multiline$ebnf$6", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "case_multiline", "symbols": [{"literal":"case"}, {"literal":"*"}, "__", "superValue", "_", {"literal":":"}, "statements", "case_multiline$ebnf$6"], "postprocess":  v => assign(v[0], {
            type: 'broken_case',
            value: v[3],
            statements: v[6]
        }) },
    {"name": "case_default$ebnf$1$subexpression$1", "symbols": [{"literal":";"}, "_"]},
    ...
    {"name": "case_default$ebnf$2$subexpression$1", "symbols": ["_", {"literal":";"}]},
    {"name": "case_default$ebnf$2", "symbols": ["case_default$ebnf$2$subexpression$1"], "postprocess": id},
    {"name": "case_default$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "case_default", "symbols": [{"literal":"default"}, "_", {"literal":":"}, "_", {"literal":"{"}, "statements", "_", "case_default$ebnf$1", {"literal":"}"}, "case_default$ebnf$2"], "postprocess":  v => assign(v[0], {
            type: 'case_default',
            value: v[5],
            scoped: true
        }) },
    {"name": "case_default$ebnf$3$subexpression$1", "symbols": ["_", {"literal":";"}]},
    {"name": "case_default$ebnf$3", "symbols": ["case_default$ebnf$3$subexpression$1"], "postprocess": id},
    {"name": "case_default$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "case_default", "symbols": [{"literal":"default"}, "_", {"literal":":"}, "statements", "case_default$ebnf$3"], "postprocess":  v => assign(v[0], {
            type: 'case_default',
            value: v[3]
        }) },
    ...
    {"name": "es6_key_value$subexpression$1", "symbols": ["identifier"]},
    {"name": "es6_key_value$subexpression$1", "symbols": [(lexer.has("keyword") ? {type: "keyword"} : keyword)], "postprocess": (v, l, reject) => v.value == 'constructor' ? reject : v},
    {"name": "es6_key_value", "symbols": ["es6_key_value$subexpression$1", "_", "arguments_with_types", "statements_block"], "postprocess": classes.es6_key_value},
    {"name": "if_block", "symbols": ["if_block", "_", "else_block"], "postprocess":  (v, l, r) => {
            return {
                type: 'if_else_if',
                if: v[0],
                else: v[2],
    ...
    {"name": "if_block$subexpression$1", "symbols": [{"literal":"if"}]},
    {"name": "if_block$subexpression$1", "symbols": [{"literal":"unless"}]},
    {"name": "if_block", "symbols": ["if_block$subexpression$1", "statement_condition", "statements_block"], "postprocess":  v => {
            // works perfectly
        	return {
        		type: 'if',
        		condition: v[1],
    ...
    {"name": "else_block", "symbols": [{"literal":"else"}, "_", {"literal":"if"}, "statement_condition", "statements_block"], "postprocess":  v => {
            return assign(v[0], {
                type: 'else_if',
                condition: v[3],
                value: v[4],
    ...
    {"name": "var_assign", "symbols": ["assign_type", "var_assign_list_w_destruction"], "postprocess": vars.assign},
    ...
    {"name": "var_assign_list_w_destruction$ebnf$1", "symbols": []},
    {"name": "var_assign_list_w_destruction$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "var_reassign_w_destruction"], "postprocess": v => v[3]},
    {"name": "var_assign_list_w_destruction$ebnf$1", "symbols": ["var_assign_list_w_destruction$ebnf$1", "var_assign_list_w_destruction$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "var_assign_list_w_destruction", "symbols": ["var_reassign_w_destruction", "var_assign_list_w_destruction$ebnf$1"], "postprocess": vars.var_assign_list},
    {"name": "var_reassign_w_destruction", "symbols": ["var_reassign"], "postprocess": id},
    {"name": "var_reassign_w_destruction$ebnf$1", "symbols": []},
    {"name": "var_reassign_w_destruction$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "id_or_rest"]},
    {"name": "var_reassign_w_destruction$ebnf$1", "symbols": ["var_reassign_w_destruction$ebnf$1", "var_reassign_w_destruction$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "var_reassign_w_destruction", "symbols": [{"literal":"{"}, "_", "id_or_rest", "var_reassign_w_destruction$ebnf$1", "_", {"literal":"}"}, "_", {"literal":"="}, "_", "superValue"], "postprocess":  v => ({
    ...
    {"name": "id_or_rest", "symbols": ["identifier"], "postprocess": v => v[0]},
    {"name": "id_or_rest", "symbols": [{"literal":"..."}, "_", "identifier"], "postprocess":  v => {
            v[2].value = '...' + v[2].value
            return v[2]
        } },
    ...
    {"name": "for_block$subexpression$6", "symbols": ["var_assign"]},
    {"name": "for_block$subexpression$6", "symbols": ["var_assign_list"]},
    {"name": "for_block", "symbols": [{"literal":"for"}, "_", {"literal":"("}, "_", "for_block$subexpression$6", "_", {"literal":";"}, "statement_condition", "_", {"literal":";"}, "_", "superValue", "_", {"literal":")"}, "statements_block"], "postprocess":   v => {
        	return assign(v[0], {
        		type: 'for_loop_regular',
        		condition: v[7],
        		identifier: v[4][0],
    ...
    {"name": "for_block", "symbols": ["number", "__nbsp", {"literal":"times"}, "statements_block"], "postprocess":  v => {
            return assign(v[0], {
                type: 'times_loop',
                times: v[0].value,
                value: v[3],
    ...
    {"name": "anonymous_function$ebnf$5$subexpression$1", "symbols": [{"literal":"async"}, "__"]},
    {"name": "anonymous_function$ebnf$5", "symbols": ["anonymous_function$ebnf$5$subexpression$1"], "postprocess": id},
    {"name": "anonymous_function$ebnf$5", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "anonymous_function", "symbols": ["anonymous_function$ebnf$5", "arguments_with_types", "__nbsp", {"literal":"="}, {"literal":">"}, "statements_block"], "postprocess":  (v, l, r) => {
            if (v[5].inline) {
    ...
    {"name": "return$subexpression$1$ebnf$1$subexpression$1", "symbols": ["__nbsp", "superValue"]},
    {"name": "return$subexpression$1$ebnf$1", "symbols": ["return$subexpression$1$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "return$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "return$subexpression$1$subexpression$1", "symbols": [{"literal":"when"}]},
    {"name": "return$subexpression$1$subexpression$1", "symbols": [{"literal":"when"}, "__", {"literal":"not"}]},
    {"name": "return$subexpression$1", "symbols": ["return$subexpression$1$ebnf$1", "__", "return$subexpression$1$subexpression$1", "statement_condition"]},
    {"name": "return", "symbols": [{"literal":"return"}, "return$subexpression$1"], "postprocess":  v => {
            let unless = !!v[1][2][2]
            return {
                type: 'return',
    ...
    {"name": "argument_identifier_and_value", "symbols": [{"literal":"..."}, "_", "identifier"], "postprocess":  v => ({
    ...
    {"name": "multiplicative$subexpression$1", "symbols": [{"literal":"/"}]},
    {"name": "multiplicative$subexpression$1", "symbols": [{"literal":"%"}]},
    {"name": "multiplicative$subexpression$1", "symbols": [{"literal":"~"}, {"literal":"/"}]},
    {"name": "multiplicative", "symbols": ["multiplicative", "_", "multiplicative$subexpression$1", "_", "exponentiation"], "postprocess":  v => ({
            type: 'multiplicative',
            left: v[0],
            right: v[4],
            operator: v[2][0].value
    ...
    {"name": "base", "symbols": ["string_concat"], "postprocess": id},
    ...
    {"name": "EOL", "symbols": ["__"], "postprocess":  (v, l, r) => {
            if (!/(\n|\r)/.test(v[0].value)) {
                return r
            }
            return 'EOL'
        } },
    {"name": "EOL$ebnf$1$subexpression$1$ebnf$1", "symbols": []},
    {"name": "EOL$ebnf$1$subexpression$1$ebnf$1", "symbols": ["EOL$ebnf$1$subexpression$1$ebnf$1", /[^\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL$ebnf$1$subexpression$1", "symbols": ["_nbsp", {"literal":"/"}, {"literal":"/"}, "EOL$ebnf$1$subexpression$1$ebnf$1", "_"]},
    ...
    {"name": "EOL", "symbols": ["_nbsp", {"literal":";"}, "EOL$ebnf$1"], "postprocess":  (v, l, r) => {
            if (v[2]) {
    ...
    {"name": "EOL$ebnf$2", "symbols": ["EOL$ebnf$2", /[^\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL", "symbols": ["_nbsp", {"literal":"/"}, {"literal":"/"}, "EOL$ebnf$2", "_"], "postprocess":  v => {
            if (v[4].value.length && !/(\n|\r)/.test(v[4].value)) {
                return 'EOL'
            }
            return 'EOL'
