...
const lexer = moo.compile({
    ...
    keyword: {
        ...
        match: ['void', 'constructor', 'null', 'Infinity'
            , 'undefined', 'globalThis', 'THAT', 'DELETE'
        ...
        match: ['Boolean', 'Number', 'String', 'Array'
            , 'Object', 'Function', 'Int', 'Float', 'JSON', 'NaN'].map(i => new RegExp(`\\b${i}\\b`)),
        ...
        match: ['const', 'var', 'delete', 'free'
            ...
            , 'WRITE', 'sizeof', 'typeof', 'this'].map(i => new RegExp(`\\b${i}\\b`)),
    },
...
const statement = {
    ...
    delete: v => assign(v[0], {type: 'delete', value: v[1] }),
    free: v => assign(v[0], {type: 'free', value: v[1] }),
    sleep: v => assign(v[0], {type: 'sleep', value: v[1] }),
    throw: v => assign(v[0], {
        type: 'throw',
        value: v[2]
    }),
...
var grammar = {
    ...
    {"name": "statement", "symbols": [{"literal":"delete"}, "arguments"], "postprocess": statement.delete},
    {"name": "statement", "symbols": [{"literal":"free"}, "arguments"], "postprocess": statement.free},
    ...
    {"name": "_base", "symbols": ["array"], "postprocess": id},
    {"name": "_base", "symbols": ["regexp"], "postprocess": id},
    {"name": "_base", "symbols": ["object"], "postprocess": id},
    ...
    {"name": "base", "symbols": ["function_call"], "postprocess": id},
    {"name": "base", "symbols": ["allowed_keywords"], "postprocess": id},
    ...
    {"name": "_value", "symbols": [{"literal":"private"}, "statements_block"], "postprocess":  v => {
            return {
                type: 'private',
                value: v[1],
                line: v[0].line,
