...
var grammar = {
    ...
    {"name": "statements$ebnf$2$subexpression$1", "symbols": ["_", "statement"]},
    ...
    {"name": "statements", "symbols": ["statements$ebnf$1", "statements$ebnf$2", "_"], "postprocess":  v => {
        	let result = []
            if (v[0] && v[0].length) {
                //debugger
    ...
    {"name": "ternary", "symbols": ["value", "_nbsp", {"literal":"if"}, "_", "condition", "ternary$ebnf$2"], "postprocess": condition.ternary_with_if},
    ...
    {"name": "var_reassign", "symbols": ["nameList"], "postprocess":  v => {
            return {
                type: 'var_reassign',
                identifier: v[0],
                line: v[0].line,
    ...
    {"name": "value", "symbols": ["value$subexpression$1", "__", "prefixExp"], "postprocess":  v => {
        	return assign(v[0][0], {
        		type: v[0][0].text,
        		value: v[2]
        	})
        } },
    {"name": "value", "symbols": ["prefixExp", "__", {"literal":"instanceof"}, "__", "prefixExp"], "postprocess":  v => ({
        	type: 'instanceof',
        	left: v[0],
        	value: v[4]
        }) },
    {"name": "value", "symbols": ["condition_as_value"], "postprocess": id},
    {"name": "value", "symbols": ["switch_multiple"], "postprocess": id},
    ...
    {"name": "prefixExp", "symbols": ["ternary"], "postprocess": id},
    ...
    {"name": "EOL$ebnf$6", "symbols": ["EOL$ebnf$6", /[ \t]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL$ebnf$7$subexpression$1$ebnf$1", "symbols": []},
    {"name": "EOL$ebnf$7$subexpression$1$ebnf$1", "symbols": ["EOL$ebnf$7$subexpression$1$ebnf$1", /[^\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL$ebnf$7$subexpression$1$ebnf$2", "symbols": []},
    {"name": "EOL$ebnf$7$subexpression$1$ebnf$2", "symbols": ["EOL$ebnf$7$subexpression$1$ebnf$2", /[\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL$ebnf$7$subexpression$1", "symbols": [{"literal":"/"}, {"literal":"/"}, "EOL$ebnf$7$subexpression$1$ebnf$1", "EOL$ebnf$7$subexpression$1$ebnf$2"]},
    {"name": "EOL$ebnf$7", "symbols": ["EOL$ebnf$7$subexpression$1"], "postprocess": id},
    {"name": "EOL$ebnf$7", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EOL", "symbols": ["EOL$ebnf$5", {"literal":";"}, "EOL$ebnf$6", "EOL$ebnf$7"], "postprocess": v => v[1]},
