...
var grammar = {
    ...
    {"name": "prefixExp$ebnf$1$subexpression$1", "symbols": ["_", {"literal":":"}, "_", "value"]},
    {"name": "prefixExp$ebnf$1", "symbols": ["prefixExp$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "prefixExp$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "prefixExp", "symbols": ["condition", "_", {"literal":"?"}, "_", "value", "prefixExp$ebnf$1"], "postprocess": condition.ternary},
    {"name": "prefixExp$ebnf$2$subexpression$1", "symbols": ["_", {"literal":"else"}, "_", "value"]},
    {"name": "prefixExp$ebnf$2", "symbols": ["prefixExp$ebnf$2$subexpression$1"], "postprocess": id},
    {"name": "prefixExp$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "prefixExp", "symbols": ["value", "_", {"literal":"if"}, "_", "condition", "prefixExp$ebnf$2"], "postprocess": condition.ternary_with_if},
    ...
    {"name": "EOL$ebnf$8", "symbols": []},
    {"name": "EOL$ebnf$8", "symbols": ["EOL$ebnf$8", /[\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL", "symbols": ["EOL$ebnf$5", {"literal":";"}, "EOL$ebnf$6", {"literal":"/"}, {"literal":"/"}, "EOL$ebnf$7", "EOL$ebnf$8"], "postprocess": v => v[1]},
