...
var grammar = {
    ...
    {"name": "statement$ebnf$1$subexpression$1", "symbols": ["__nbsp", "statement$ebnf$1$subexpression$1$subexpression$1", "statement_condition"]},
    ...
    {"name": "return$subexpression$1", "symbols": ["return$subexpression$1$ebnf$1", "__nbsp", "return$subexpression$1$subexpression$1", "statement_condition"]},
    ...
    {"name": "EOL$ebnf$1$subexpression$1$ebnf$2", "symbols": []},
    {"name": "EOL$ebnf$1$subexpression$1$ebnf$2", "symbols": ["EOL$ebnf$1$subexpression$1$ebnf$2", /[\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL$ebnf$1$subexpression$1", "symbols": ["_nbsp", {"literal":"/"}, {"literal":"/"}, "EOL$ebnf$1$subexpression$1$ebnf$1", "EOL$ebnf$1$subexpression$1$ebnf$2"]},
    ...
    {"name": "EOL", "symbols": ["_nbsp", {"literal":";"}, "EOL$ebnf$1"], "postprocess": v => v[1]},
    {"name": "EOL$ebnf$2", "symbols": []},
    {"name": "EOL$ebnf$2", "symbols": ["EOL$ebnf$2", /[^\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL$ebnf$3", "symbols": []},
    {"name": "EOL$ebnf$3", "symbols": ["EOL$ebnf$3", /[\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL", "symbols": ["_nbsp", {"literal":"/"}, {"literal":"/"}, "EOL$ebnf$2", "EOL$ebnf$3"], "postprocess": v => 'EOL'},
