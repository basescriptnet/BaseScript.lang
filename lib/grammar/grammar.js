...
var grammar = {
    ...
    {"name": "elif", "symbols": [{"literal":"elif"}, "statement_condition", "statements_block"], "postprocess":  v => {
            return {
                type: 'elif',
                condition: v[1],
                value: v[2],
    ...
    {"name": "elif", "symbols": ["elif", "_", "else_block"], "postprocess":  v => {
            return {
                type: 'elif_else',
                elif: v[0],
                else: v[2],
    ...
    {"name": "elif", "symbols": ["elif", "_", "elif"], "postprocess":  v => {
            return {
                type: 'elif_elif',
                elif: v[0],
                elif2: v[2],
    ...
    {"name": "var_reassign_w_destruction$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "identifier"]},
    ...
    {"name": "var_reassign_w_destruction", "symbols": [{"literal":"{"}, "_", "identifier", "var_reassign_w_destruction$ebnf$1", "_", {"literal":"}"}, "_", {"literal":"="}, "_", "superValue"], "postprocess":  v => ({
