...
var grammar = {
    ...
    {"name": "template", "symbols": [{"literal":"`"}, "template_body", {"literal":"`"}], "postprocess":  v => {
            return {
                type: 'template',
                value: v[1],
                line: v[0].line, col: v[0].col, offset: v[0].offset,
    ...
    {"name": "tempalte_body", "symbols": ["template_string"], "postprocess":  v => {
            return {
    ...
    {"name": "tempalte_body", "symbols": ["template_string", "_", {"literal":"{"}, "_", "value", "_", {"literal":"}"}], "postprocess":  v => {
            return {
    ...
    {"name": "template_string$ebnf$1", "symbols": []},
    {"name": "template_string$ebnf$1", "symbols": ["template_string$ebnf$1", /[A-Za-z0-9\s]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "template_string", "symbols": ["template_string$ebnf$1"], "postprocess":  v => {
            return {
                type: 'template_string',
                value: v[0],
                line: v[0].line, col: v[0].col, offset: v[0].offset,
    ...
    {"name": "template_body2", "symbols": ["template_body", "template_body_part"], "postprocess":  v => {
            return [
                ...v[0],
                v[1]
            ]
        } },
    {"name": "template_body2", "symbols": ["template_body_part"], "postprocess": v => [v[0]]},
    {"name": "template_body_part", "symbols": [{"literal":"$"}, {"literal":"{"}, "_", "value", "_", {"literal":"}"}], "postprocess":  v => {
            return {
    ...
    {"name": "template_body_part$ebnf$1", "symbols": []},
    {"name": "template_body_part$ebnf$1", "symbols": ["template_body_part$ebnf$1", /[^`\\$]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "template_body_part", "symbols": ["template_body_part$ebnf$1"], "postprocess":  v => {
            console.log(v[0][0])
            return {
                type: 'template_body_part',
                value: v[0][0],
    ...
    {"name": "Var", "symbols": ["base", "_nbsp", {"literal":"["}, "_", {"literal":"]"}], "postprocess":  (v, l, reject) => assure(v, l, reject, {
    ...
    {"name": "switch", "symbols": [{"literal":"caseof"}, "_", "superValue", "_", {"literal":"{"}, "switch$ebnf$1", "_", {"literal":"}"}], "postprocess":  v => assign(v[0], {
        	type: 'switch*',
        	value: v[2],
    ...
    {"name": "case_single_valued", "symbols": [{"literal":"|"}, "_", "superValue", "_", {"literal":":"}, "_", "case_single_valued$ebnf$1"], "postprocess":  v => assign(v[0], {
    ...
    {"name": "value_reassign", "symbols": ["left_assign", "_", {"literal":"="}, "_", "superValue"], "postprocess":  v => {
        	return {
        		type: 'var_reassign',
        		identifier: v[0],
        		line: v[0].line,
    ...
    {"name": "value_addition2$subexpression$1", "symbols": [{"literal":"+"}, {"literal":"="}]},
    {"name": "value_addition2$subexpression$1", "symbols": [{"literal":"-"}, {"literal":"="}]},
    {"name": "value_addition2$subexpression$1", "symbols": [{"literal":"*"}, {"literal":"="}]},
    {"name": "value_addition2$subexpression$1", "symbols": [{"literal":"/"}, {"literal":"="}]},
    {"name": "value_addition2", "symbols": ["prefixExp", "_nbsp", "value_addition2$subexpression$1", "_", "sum"], "postprocess":  (v, l, reject) => {
    ...
    {"name": "array_interactions", "symbols": [{"literal":"..."}, "_", "base"], "postprocess":  v => ({
    ...
    {"name": "unary2$subexpression$1", "symbols": [{"literal":"!"}, "_"]},
    {"name": "unary2", "symbols": ["unary2$subexpression$1", "unary2"], "postprocess":  (v, l, reject) => ({
            type: 'reversed_unary',
            value: v[1],
            operator: '!',
    ...
    {"name": "unary2$subexpression$2", "symbols": [{"literal":"--"}]},
    {"name": "unary2", "symbols": ["unary2$subexpression$2", "_nbsp", "base"], "postprocess":  (v, l, reject) => {
    ...
    {"name": "conditional", "symbols": ["logical_or", "_", {"literal":"?"}, "_", "conditional", "_", {"literal":":"}, "_", "conditional"], "postprocess":  (v, l, reject) => ({
            type: 'conditional',
            condition: v[0],
            true: v[4],
            false: v[6]
        }) },
    {"name": "conditional", "symbols": ["logical_or", "_", {"literal":"?"}, "_", "conditional"], "postprocess":  (v, l, reject) => ({
            type: 'conditional',
            condition: v[0],
            true: v[4],
            false: null
    ...
    {"name": "base", "symbols": ["annonymous_function"], "postprocess": id},
    ...
    {"name": "superValue$ebnf$1", "symbols": []},
    {"name": "superValue$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "spread"]},
    {"name": "superValue$ebnf$1", "symbols": ["superValue$ebnf$1", "superValue$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "superValue", "symbols": ["base", "__nbsp", "spread", "superValue$ebnf$1"], "postprocess":  (v, l, reject) => {
    ...
    {"name": "inline_argument", "symbols": ["spread"], "postprocess": id},
    {"name": "inline_argument", "symbols": [{"literal":"."}], "postprocess":  v => ({
            type: 'placeholder',
            value: null,
            line: v[0].line,
            col: v[0].col
        }) },
    {"name": "value2", "symbols": ["condition"], "postprocess": id},
    {"name": "value2", "symbols": ["ternary"], "postprocess": id},
    ...
    {"name": "pipeline$ebnf$1$subexpression$1", "symbols": ["_", {"literal":"|>"}, "_", "value"]},
    {"name": "pipeline$ebnf$1", "symbols": ["pipeline$ebnf$1$subexpression$1"]},
    {"name": "pipeline$ebnf$1$subexpression$2", "symbols": ["_", {"literal":"|>"}, "_", "value"]},
    {"name": "pipeline$ebnf$1", "symbols": ["pipeline$ebnf$1", "pipeline$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "pipeline", "symbols": ["value", "pipeline$ebnf$1"], "postprocess":  v => ({
            type: 'pipeline',
            left: v[0],
            right: v[4],
            line: v[0].line,
