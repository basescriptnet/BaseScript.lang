...
var grammar = {
    ...
    {"name": "pow$subexpression$2", "symbols": [{"literal":"|"}]},
    {"name": "pow$subexpression$2", "symbols": [{"literal":"&"}]},
    {"name": "pow$subexpression$2", "symbols": [{"literal":">>>"}]},
    {"name": "pow$subexpression$2", "symbols": [{"literal":"<<"}]},
    {"name": "pow$subexpression$2", "symbols": [{"literal":">>"}]},
    {"name": "pow$subexpression$2", "symbols": [{"literal":"^"}]},
    {"name": "pow", "symbols": ["base", "_nbsp", "pow$subexpression$2", "_", "base"], "postprocess":  v => ({
            type: 'bitwise_middle',
            left: v[0],
            operator: v[2][0].value,
            right: v[4],
        }) },
    {"name": "pow$ebnf$1", "symbols": [{"literal":"~"}]},
    {"name": "pow$ebnf$1", "symbols": ["pow$ebnf$1", {"literal":"~"}], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "pow", "symbols": ["pow$ebnf$1", "_nbsp", "base"], "postprocess":  v => ({
            type: 'bitwise_not',
