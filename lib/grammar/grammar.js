...
var grammar = {
    Lexer: lexer,
    ParserRules: [
    {"name": "process", "symbols": ["decorated_statements", "_"], "postprocess": id},
    ...
    {"name": "statement", "symbols": [{"literal":"delete"}, "__", "value"], "postprocess": statement.delete},
    ...
    {"name": "statement", "symbols": ["switch_multiple"], "postprocess": id},
    ...
    {"name": "statements_block", "symbols": ["_", {"literal":"{"}, "statements", "_", "statements_block$ebnf$1", {"literal":"}"}], "postprocess": v => v[2]},
    ...
    {"name": "statements_block", "symbols": ["_", {"literal":"BEGIN"}, "__", "statements", "_", "statements_block$ebnf$2", {"literal":"END"}], "postprocess": v => v[3]},
    ...
    {"name": "allowed_keywords", "symbols": [{"literal":"true"}], "postprocess": id},
    {"name": "allowed_keywords", "symbols": [{"literal":"false"}], "postprocess": id},
    {"name": "allowed_keywords", "symbols": [{"literal":"_"}], "postprocess": id},
    ...
    {"name": "string", "symbols": [{"literal":"typeof"}, "__", "prefixExp"], "postprocess":  v => ({
        	type: 'typeof',
        	value: v[2]
        }) },
    ...
    {"name": "Var", "symbols": ["prefixExp", "_", {"literal":"["}, "Var$subexpression$1", "_", {"literal":":"}, "Var$ebnf$1", "Var$ebnf$2", "_", {"literal":"]"}], "postprocess": array.slice},
    ...
    {"name": "Var", "symbols": ["prefixExp", "_", {"literal":"."}, "_", "Var$subexpression$2"], "postprocess":  v => ({
    ...
    {"name": "value_reassign", "symbols": ["prefixExp", "_", {"literal":"="}, "_", "value_reassign$subexpression$1"], "postprocess":  v => {
        	return {
        		type: 'var_reassign',
        		identifier: v[0],
        		line: v[0].line,
    ...
    {"name": "annonymous_function", "symbols": ["annonymous_function$ebnf$1", "annonymous_function$subexpression$1", "annonymous_function$ebnf$2", "_", "arguments_with_types", "statements_block"], "postprocess": functions.annonymous},
    ...
    {"name": "annonymous_function", "symbols": ["annonymous_function$ebnf$3", "annonymous_function$subexpression$2", "annonymous_function$ebnf$4", "statements_block"], "postprocess": functions.annonymous_with_no_args},
    ...
    {"name": "return", "symbols": [{"literal":"return"}, "__", "value"], "postprocess": returns.value},
    ...
    {"name": "comparision_operators", "symbols": [{"literal":"is"}, "_", {"literal":"not"}], "postprocess": v => assign(v[0], {type: 'comparision_operator', value: '!==' })},
    ...
    {"name": "condition", "symbols": ["condition", "_", "comparision_operators", "_", "_value"], "postprocess":  v => {
            return {
                type: 'condition',
                left: v[0],
                right: v[4],
    ...
    {"name": "debugging", "symbols": ["debugging$subexpression$1", "debugging_body"], "postprocess":  v => ({
        	type: 'debugging',
        	method: 'log',
        	value: v[1]
        }) },
    {"name": "debugging", "symbols": [{"literal":"ERROR"}, "debugging_body"], "postprocess":  v => ({
        	type: 'debugging',
        	method: 'error',
        	value: v[1]
        }) },
    {"name": "debugging", "symbols": [{"literal":"WRITE"}, "debugging_body"], "postprocess":  v => ({
        	type: 'debugging',
        	method: 'write',
        	value: v[1]
        }) },
    {"name": "debugging_body", "symbols": ["__", "value"], "postprocess": v => v[1]},
    {"name": "debugging_body", "symbols": ["_", {"literal":"("}, "_", "value", "_", {"literal":")"}], "postprocess": v => v[3]},
    ...
    {"name": "expression$subexpression$1", "symbols": [{"literal":"*"}, {"literal":"="}]},
    {"name": "expression$subexpression$1", "symbols": [{"literal":"/"}, {"literal":"="}]},
    {"name": "expression", "symbols": ["expression", "_", "expression$subexpression$1", "_", "prefixExp"], "postprocess":  v => ({
        	type: 'expression',
    ...
    {"name": "expression$subexpression$2", "symbols": [{"literal":"/"}]},
    {"name": "expression$subexpression$2", "symbols": [{"literal":"%"}]},
    {"name": "expression", "symbols": ["expression", "_", "expression$subexpression$2", "_", "prefixExp"], "postprocess":  v => ({
        	type: 'expression',
        	value: [v[0], v[2][0], v[4]]
        }) },
    ...
    {"name": "_value", "symbols": ["switch_multiple"], "postprocess": id},
    ...
    {"name": "prefixExp", "symbols": ["html"], "postprocess": id},
    ...
    {"name": "EOL$ebnf$3", "symbols": ["EOL$ebnf$3", /[ \t]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL$ebnf$4$subexpression$1$ebnf$1", "symbols": []},
    {"name": "EOL$ebnf$4$subexpression$1$ebnf$1", "symbols": ["EOL$ebnf$4$subexpression$1$ebnf$1", /[^\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL$ebnf$4$subexpression$1$ebnf$2", "symbols": []},
    {"name": "EOL$ebnf$4$subexpression$1$ebnf$2", "symbols": ["EOL$ebnf$4$subexpression$1$ebnf$2", /[\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL$ebnf$4$subexpression$1", "symbols": [{"literal":"/"}, {"literal":"/"}, "EOL$ebnf$4$subexpression$1$ebnf$1", "EOL$ebnf$4$subexpression$1$ebnf$2"]},
    {"name": "EOL$ebnf$4", "symbols": ["EOL$ebnf$4$subexpression$1"], "postprocess": id},
    {"name": "EOL$ebnf$4", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EOL", "symbols": ["EOL$ebnf$2", {"literal":";"}, "EOL$ebnf$3", "EOL$ebnf$4"], "postprocess": v => v[1]},
    {"name": "EOL$ebnf$5", "symbols": []},
    {"name": "EOL$ebnf$5", "symbols": ["EOL$ebnf$5", /[ \t]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL$ebnf$6", "symbols": []},
    {"name": "EOL$ebnf$6", "symbols": ["EOL$ebnf$6", /[^\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL$ebnf$7", "symbols": []},
    {"name": "EOL$ebnf$7", "symbols": ["EOL$ebnf$7", /[\n]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EOL", "symbols": ["EOL$ebnf$5", {"literal":"/"}, {"literal":"/"}, "EOL$ebnf$6", "EOL$ebnf$7"], "postprocess": v => 'EOL'},
    ...
    {"name": "__nbsp$ebnf$1", "symbols": [/[ \t]/]},
    {"name": "__nbsp$ebnf$1", "symbols": ["__nbsp$ebnf$1", /[ \t]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "__nbsp", "symbols": ["__nbsp$ebnf$1"], "postprocess": v => ''}
]
  , ParserStart: "process"
}
