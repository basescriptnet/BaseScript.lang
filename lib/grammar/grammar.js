...
var grammar = {
    ...
    {"name": "Var$subexpression$1", "symbols": [(lexer.has("keyword") ? {type: "keyword"} : keyword)]},
    {"name": "Var$subexpression$1", "symbols": ["identifier"]},
    {"name": "Var", "symbols": ["prefixExp", "_", {"literal":"."}, "_", "Var$subexpression$1"], "postprocess":  v => ({
    ...
    {"name": "expression", "symbols": ["prefixExp", "_", {"literal":"["}, "expression$subexpression$1", "_", {"literal":":"}, "expression$ebnf$1", "expression$ebnf$2", "_", {"literal":"]"}], "postprocess": array.slice},
