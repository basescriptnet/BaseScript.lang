...
var grammar = {
    ...
    {"name": "value_addition$subexpression$1", "symbols": [{"literal":"^="}]},
    {"name": "value_addition$subexpression$1", "symbols": [{"literal":"|="}]},
    {"name": "value_addition", "symbols": ["value", "_", "value_addition$subexpression$1", "_", "value"], "postprocess":  (v, l, reject) => ({
    ...
    {"name": "pipeforward", "symbols": ["pipeback", "_", {"literal":"|>"}, "_", "pipeforward"], "postprocess":  (v, l, reject) => ({
            type: 'pipeforward',
            left: v[0],
            right: v[4]
        }) },
    {"name": "pipeforward", "symbols": ["pipeback"], "postprocess": id},
    {"name": "statement_condition", "symbols": ["_", "conditional"], "postprocess": v => v[1]},
