...
var grammar = {
    ...
    {"name": "Var", "symbols": ["prefixExp", "_", {"literal":"["}, "_", {"literal":"]"}], "postprocess":  v => ({
    ...
    {"name": "Var", "symbols": ["prefixExp", "_", {"literal":"["}, "_", "value", "_", {"literal":"]"}], "postprocess":  v => ({
    ...
    {"name": "function_call", "symbols": ["prefixExp", "_", "arguments"], "postprocess":  v => {
        	return ({
        		type: 'function_call',
        		value: v[0],
        		arguments: v[2],
