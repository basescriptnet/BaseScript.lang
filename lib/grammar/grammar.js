...
var grammar = {
    ...
    {"name": "Var", "symbols": ["prefixExp", "_", {"literal":"."}, "_", "Var$subexpression$2"], "postprocess":  (v, l, reject) => {
    ...
    {"name": "function_call", "symbols": ["prefixExp", "_nbsp", "arguments"], "postprocess":  (v, l, reject) => {
            if (v[0].type == 'annonymous_function') return reject
        	return ({
        		type: 'function_call',
        		value: v[0],
