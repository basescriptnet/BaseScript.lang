...
var grammar = {
    ...
    {"name": "expression$subexpression$1", "symbols": [{"literal":"*"}, {"literal":"="}]},
    {"name": "expression$subexpression$1", "symbols": [{"literal":"/"}, {"literal":"="}]},
    {"name": "expression", "symbols": ["expression", "_nbsp", "expression$subexpression$1", "_", "prefixExp"], "postprocess":  (v, l, reject) => {
    ...
    {"name": "expression$subexpression$2", "symbols": [{"literal":"/"}]},
    {"name": "expression$subexpression$2", "symbols": [{"literal":"%"}]},
    {"name": "expression", "symbols": ["expression", "_nbsp", "expression$subexpression$2", "_", "prefixExp"], "postprocess":  (v, l, reject) => {
            if (v[0].type == 'annonymous_function') return reject;
            return ({
                type: 'expression',
                value: [v[0], v[2][0], v[4]]
