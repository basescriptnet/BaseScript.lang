...
var grammar = {
    ...
    {"name": "for_block$subexpression$2", "symbols": [{"literal":"through"}]},
    {"name": "for_block$subexpression$2", "symbols": [{"literal":"till"}]},
    {"name": "for_block", "symbols": [{"literal":"for"}, "__", "identifier", "__", {"literal":"from"}, "__", "value", "_", "for_block$subexpression$2", "_", "value", "statements_block"], "postprocess":   v => {
        	return assign(v[0], {
        		type: 'for_loop',
        		identifier: v[2],
        		from: v[6],
    ...
    {"name": "for_block$subexpression$3", "symbols": ["var_assign"]},
    {"name": "for_block$subexpression$3", "symbols": ["var_assign_list"]},
    {"name": "for_block", "symbols": [{"literal":"for"}, "__", "for_block$subexpression$3", "_", {"literal":";"}, "_", "statement_condition", "_", {"literal":";"}, "_", "value_reassign", "statements_block"], "postprocess":   v => {
        	return assign(v[0], {
        		type: 'for_loop',
        		condition: v[6],
        		identifier: v[2][0],
    ...
    {"name": "html", "symbols": [{"literal":"{{"}, "_", "value", "_", {"literal":"}}"}], "postprocess": html.value_to_string},
