...
var grammar = {
    Lexer: lexer,
    ParserRules: [
    {"name": "process$subexpression$1", "symbols": ["_"]},
    {"name": "process$subexpression$1", "symbols": ["EOL"]},
    {"name": "process", "symbols": ["decorated_statements", "process$subexpression$1"], "postprocess": id},
    ...
    {"name": "statements_block", "symbols": ["_", {"literal":"do"}, "__", "statement"], "postprocess": v => [v[3]]},
    ...
    {"name": "argument_type$ebnf$1$subexpression$1$subexpression$1", "symbols": [(lexer.has("keyword") ? {type: "keyword"} : keyword)]},
    {"name": "argument_type$ebnf$1$subexpression$1$subexpression$1", "symbols": ["identifier"]},
    ...
    {"name": "argument_type$ebnf$1$subexpression$1", "symbols": ["argument_type$ebnf$1$subexpression$1$subexpression$1", "argument_type$ebnf$1$subexpression$1$ebnf$1", "__"]},
    ...
    {"name": "condition", "symbols": ["condition", "_", "comparision_operators", "_", "arguments"], "postprocess":  (v, l, value) => {
