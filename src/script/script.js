...
var div = BS.Node("div", null, null, null, [BS.Node("ul", null, null, null, [BS.valueToDOM(BS.through(1, 5, 3, 9).map((function(i) {

    const args = Array.from(arguments || []);
    return BS.Node("li", null, null, null, [BS.valueToDOM(i)]);
})))])]);
(() => {
    if (BS.getType(div) !== 'HTML') {
        let el = document.createTextNode(div);
